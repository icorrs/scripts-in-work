...
from cost_analysis.cost_analysis import translate_title
...
def get_detail_wbs(engine,date):
    ...
    sql_query='''
                ...
                from detail_wbs,%s_quantity,detail_wbs_code_vs_sub_contractor_short_name
                where detail_wbs.detail_wbs_code=%s_quantity.detail_wbs_code and 
                      detail_wbs_code_vs_sub_contractor_short_name.detail_wbs_code=detail_wbs.detail_wbs_code
                '''%(date,date,date,date)
